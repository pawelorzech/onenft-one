...
contract CoinRendererTest is Test {
    ...
    uint256 private constant CASES = 149;
    ...
    /// inside a call frame, so a single test over all 149 cases would keep growing.
    ...
    function test_MatchesTypeScript_F() public view { checkCases(125, 149); }
    ...
    function test_TokenUriGasWithinBudget_C() public view { checkTokenUriGas(100, 149); }
