...
- The site runs in preview mode until the contract exists: a simulated series with the same rules.

`bun test` · `PORT=3000 bun run src/server.ts` · `bun run scripts/sim.ts`
