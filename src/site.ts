...
<p>${FOUNDER_PER_SERIES} slots a series are reserved for the author, who mints them one at a time and pays their backing like anyone else, from the author wallet or from fees the contract has collected. Their art comes from the same urn. They carry the trait Origin: Founder and nothing else sets them apart. On average the author gets ${(FOUNDER_PER_SERIES * MASTERS_PER_SERIES) / SERIES_SIZE} Master Coins a series, and most often none.</p>
